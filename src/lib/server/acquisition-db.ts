...
const acquisitionSchema = `
  CREATE TABLE IF NOT EXISTS acquisition_jobs (
    ...
    recovery_selection_json TEXT,
    recovery_attempted INTEGER NOT NULL DEFAULT 0,
    recovery_status TEXT,
    release_candidates_json TEXT,
  ...
  CREATE TABLE IF NOT EXISTS acquisition_attempts (
    ...
    status TEXT NOT NULL,
    reason_code TEXT,
    detected_audio_languages_json TEXT,
    detected_subtitle_languages_json TEXT,
    release_title TEXT,
    releaser TEXT,
    reason TEXT,
    manual_selection_mode TEXT,
    submitted_guid TEXT,
...
const expectedAcquisitionTableColumns = {
  ...
  acquisition_jobs: [
    ...
    'recovery_selection_json',
    'recovery_attempted',
    'recovery_status',
    'release_candidates_json',
